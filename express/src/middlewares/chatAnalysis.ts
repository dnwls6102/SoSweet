...
function createAiPrompt(user_id: string): ChatCompletionMessageParam {
  return {
    ...
    **언어적 매너**
    ...
    다음과 같은 예시 출력 형식을 준수하세요:

    ### 예시
    json
    {
      analysis: "발화량이 상대방과 비교해 다소 많습니다. 질문을 주도적으로 이끌었으나, 공감과 반응에 있어 조금 더 부드러운 흐름을 유지할 수 있었습니다. 
      긍정적이고 예의바른 태도를 유지했고, 대화 주제를 상대방에게 연결하려는 노력이 잘 보였습니다.",
      conclusion: "전체적으로 대화 흐름을 잘 이끌었고, 자연스러운 대화를 만들어갔습니다. 
      다만, 상대방에게 공감하거나 반응하는 부분에서 좀 더 신경을 쓰면 더 균형 잡힌 대화를 기대할 수 있을 것입니다."
    }
